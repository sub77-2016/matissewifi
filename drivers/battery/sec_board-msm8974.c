...
#elif defined(CONFIG_MACH_KACTIVELTE_EUR) || defined(CONFIG_MACH_KACTIVELTE_ATT) || defined(CONFIG_MACH_KACTIVELTE_SKT)
static sec_bat_adc_table_data_t temp_table[] = {
	{26009,	900},
	{26280,	850},
	{26600,	800},
...
#define TEMP_HIGHLIMIT_RECOVERY_LPM			750
	...
	defined(CONFIG_MACH_KSPORTSLTE_SPR) || defined(CONFIG_MACH_KACTIVELTE_SKT)
