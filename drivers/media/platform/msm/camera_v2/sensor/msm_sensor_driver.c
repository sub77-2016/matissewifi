...
int32_t msm_sensor_driver_probe(void *setting)
{
...
#if !defined (CONFIG_SEC_MILLET_PROJECT) && !defined (CONFIG_SEC_MATISSE_PROJECT) \
	&& !defined(CONFIG_MACH_AFYONLTE_TMO) && !defined (CONFIG_MACH_VICTORLTE_CTC) \
	&& !defined(CONFIG_SEC_DEGAS_PROJECT) && !defined (CONFIG_SEC_T8_PROJECT) //Commenting for Millet, Matisse
	...
	|| defined(CONFIG_MACH_AFYONLTE_TMO) || defined (CONFIG_MACH_VICTORLTE_CTC) || defined(CONFIG_SEC_DEGAS_PROJECT) \
	|| defined (CONFIG_SEC_T8_PROJECT) // Added for YUV bringup
...
#if defined(CONFIG_MACH_ULC83G_EUR) || defined (CONFIG_SEC_MILLET_PROJECT) || defined(CONFIG_SEC_MATISSE_PROJECT) || defined(CONFIG_MACH_CRATERQ_CHN_OPEN) \
	|| defined(CONFIG_MACH_AFYONLTE_TMO) || defined(CONFIG_MACH_VICTORLTE_CTC) || defined(CONFIG_SEC_DEGAS_PROJECT) \
	|| defined (CONFIG_SEC_T8_PROJECT)// Added for YUV bringup ToDo.
    /* Power down */
