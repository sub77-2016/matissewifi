...
#define KS8851_IRQ_GPIO 115
	...
	defined (CONFIG_MACH_MILLETLTE_KOR) || \
...
#if defined (CONFIG_MACH_MILLETLTE_VZW) || defined (CONFIG_MACH_MILLET3G_EUR) || defined (CONFIG_MACH_MILLETLTE_OPEN) || defined (CONFIG_MACH_MILLETWIFI_OPEN) || defined (CONFIG_MACH_MILLETWIFIUS_OPEN) || defined (CONFIG_MACH_MILLETLTE_KOR)
